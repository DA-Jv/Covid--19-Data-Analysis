...
-- Total Cases vs Total Deaths & percentage of population dead

Select Location, date, total_cases,total_deaths, cast(Total_deaths/Total_cases)*100 as DeathPercentage
From Covid19..CovidDeaths
